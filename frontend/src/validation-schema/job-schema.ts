...
export const jobCreateSchema = z.object({
  jobDetail:z.object({
    ...
    vacancy: z.coerce.number<number>().int().positive("vacancy should be positive"),
    reviewerIds: z.coerce.number<number>().array(),
    hrOwnerId: z.coerce.number<number>().positive({error:"Hr owner is required"}),
  }),
