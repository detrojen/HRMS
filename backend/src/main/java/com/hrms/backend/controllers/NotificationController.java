...
public class NotificationController {
    ...
    @PatchMapping("/notifications/read/{notificationTemplateId}")
    public ResponseEntity<GlobalResponseDto<Boolean>>  setRead(@PathVariable Long notificationTemplateId){
        notificationService.setIsRead(notificationTemplateId);
