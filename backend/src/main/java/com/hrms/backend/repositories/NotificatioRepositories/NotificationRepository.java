...
public interface NotificationRepository extends JpaRepository<Notification,Long> , JpaSpecificationExecutor<Notification> {
    ...
    @Query(value = "select new com.hrms.backend.dtos.responseDtos.NotificationTemplateResponseDto( t.id,t.message as message,t.type) from Notification n join n.template t join n.employee e where e.id =:employeeId and n.isRead = false ",nativeQuery = false)
